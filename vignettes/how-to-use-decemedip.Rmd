...
Note that our package provides default reference matrices for hg19 and hg38, along with the corresponding CpG density information. The objects can be accessed by calling `hg19.ref.cts.se`, `hg19.ref.anc.se` or `hg38.ref.cts.se`, `hg38.ref.anc.se`. By default, the main function `decemedip()` applies `hg19.ref.cts.se` and `hg19.ref.anc.se` as the reference panel. Please refer to the manuscript for details of the reference panel.
